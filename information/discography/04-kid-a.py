...
overview = '''Kid A is the fourth album by the English rock band Radiohead, released on 2 October 2000 by Parlophone. They recorded Kid A with OK Computer producer Nigel Godrich in Paris, Copenhagen, Gloucestershire and their hometown Oxford, England.
...
release_info = {'Released date' : '2 October 2000',
				'Recorded' : 'January 1999 - April 2000',
				'Studio' : 'Guillaume Tell (Paris), Medley (Copenhagen), Unnamed studio (Oxford, England)',
				'Length' : '49:56',
				'Label' : 'Parlophone, Capitol',
				'Producer' : 'Nigel Godrich, Radiohead'}


track_listing = ['Everything in Its Right Place',
				'Kid A',
				'The National Anthem',
...
personel_band = {'Thom Yorke' : 'lead vocals, guitars',
				'Jonny Greenwood' : 'guitar, electronic',
				"Ed O'Brien" : "guitar, backing vocals",
				'Colin Greenwood' : 'bass',
				'Phil Selway' : 'drums'}


personel_production = {'Nigel Godrich' : 'production, engineering, mixing',
...
personel_design = {'Stanley' : 'artwork ("Landscapes, Knives and Glue")',
